...
const MainFooter = (args: any) => (
  <div>
    <Footer className="bg-neutral/80 p-10 text-neutral-content" {...args}>
      <div>
        <div className="text-accent dark:text-primary">
          <svg
            width="50"
            height="50"
            viewBox="0 0 24 24"
          ...
          <p className="py-1 text-2xl">{AppConfig.title}</p>
        </div>
